...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public float GetMyRotationAtDistance (float dst, EndOfPathInstruction endOfPathInstruction = EndOfPathInstruction.Loop) {
            float t = dst / length;
            return GetMyRotation (t, endOfPathInstruction);
        }
